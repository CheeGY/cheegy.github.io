...
use_math: true
---
This note provides key ideas and takeaways from Chapter 1 of the book, _Robust Nonlinear Control Design_, by R. Freeman and P. Kokotovic. For each idea/concept presented, references are stated explicitly (titles, authors etc.). This is to facilitate referencing and search in the future.
