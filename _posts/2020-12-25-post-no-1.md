...
$\textbf{Definition 1}$: The image of a linear map $A$, denoted by $\textbf{Im}(A)$, is defined as the set
...
$\textbf{Definition 3}$: The kernel of a linear map $A$, denoted by $\textbf{Ker}(A)$, is defined as the set 
